# Corona data and model for South Tyrol

Mathematical approximation and data for COVID-19 in South Tyrol. Second-wave data starts on 6 October 2020. For the mathematical approximation, the last 14 days are used as a data basis, projecting the next 28 days. Exponential growth and a serial interval of four days are assumed. Only PCR tests are considered for data requiring number of persons tested, i.e. WHO test indicator and test positivity. Both PCR and antigen tests are consider for number of cases. 
